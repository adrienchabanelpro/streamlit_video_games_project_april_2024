...
st.set_page_config(page_title="Video Game Sales Predictor", page_icon="🎮", layout="wide")
...
pg = st.navigation(
    [
        st.Page(_lazy("pages.home", "home_page"), title="Home", icon="🏠"),
        st.Page(_lazy("pages.data_sources", "data_sources_page"), title="Data Sources", icon="🗄️"),
        st.Page(_lazy("pages.dataviz", "dataviz_page"), title="Exploratory Analysis", icon="📊"),
        st.Page(_lazy("pages.feature_engineering", "feature_engineering_page"), title="Feature Engineering", icon="⚙️"),
        st.Page(_lazy("pages.model_training", "model_training_page"), title="Training", icon="🧠"),
        st.Page(_lazy("pages.prediction", "prediction_page"), title="Predictions", icon="🔮"),
        st.Page(_lazy("pages.interpretability", "interpretability_page"), title="Interpretability", icon="🔍"),
        st.Page(_lazy("pages.what_if", "what_if_page"), title="What-If", icon="🔬"),
        st.Page(_lazy("pages.market_insights", "market_insights_page"), title="Market Trends", icon="📈"),
        st.Page(_lazy("pages.perception", "perception_page"), title="Sentiment NLP", icon="💬"),
        st.Page(_lazy("pages.about", "about_page"), title="About", icon="ℹ️"),
    ]
)
